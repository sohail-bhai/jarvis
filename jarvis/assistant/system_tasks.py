...
def find_and_click_text(target_text):
    ...
    try:
        ...
        logger.info(f"[JARVIS Vision Error] uiautomation not available: {e}")
        speak("UI automation module is not available.")
        return False
...
def get_clickable_elements():
    ...
    try:
        try:
            ...
            return "UI Automation module (uiautomation) is not installed on this system."
