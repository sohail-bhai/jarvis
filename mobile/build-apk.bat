@echo off
REM Builds a standalone VAVE APK on Windows.
REM
...
if exist "app\build\outputs\apk\release\app-release.apk" (
    copy /y "app\build\outputs\apk\release\app-release.apk" "%MOBILE_DIR%VAVE.apk"
    echo.
    echo ==========================================
    echo  SUCCESS! Standalone APK built at:
    echo  %MOBILE_DIR%VAVE.apk
    echo ==========================================
    echo.
    echo Copy VAVE.apk to any Android phone and install it. No USB debugging,
